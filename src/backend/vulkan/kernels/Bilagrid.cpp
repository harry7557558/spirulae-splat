...
// family from kernels/bilagrid/BilagridBindings.h (affine / PPISP / log-linear / depth /
...
// init + scatter from engine/EngineInternal.h.
//
// Device work: shaders/bilagrid_{common,affine,ppisp,loglinear,depth,
