...
SS_MSG(map_pp_done,
    EN("Final principal-point refinement over {0} model(s): {1} s"),
    JA("{0} 個のモデルに対する最後の主点調整: {1} 秒"),
    ZH_HANS("对 {0} 个模型做最后的主点优化: {1} 秒"),
    ZH_HANT("對 {0} 個模型做最後的主點最佳化: {1} 秒"),
    KO("모델 {0} 개에 대한 마지막 주점 보정: {1} 초"),
    DE("Abschließende Hauptpunkt-Verfeinerung über {0} Modell(e): {1} s"),
    FR("Affinage final du point principal sur {0} modèle(s) : {1} s"),
    ES("Refinamiento final del punto principal sobre {0} modelo(s): {1} s"),
    PT("Refinamento final do ponto principal em {0} modelo(s): {1} s"),
    IT("Affinamento finale del punto principale su {0} modello/i: {1} s"),
    NL("Laatste hoofdpuntverfijning over {0} model(len): {1} s"),
    RU("Финальное уточнение главной точки по {0} моделям: {1} с"),
    TR("{0} model üzerinde son ana nokta iyileştirmesi: {1} s"));
