#include "kernels/bilagrid/BilagridUniformSampleFwd_kernel.cuh"
#include "kernels/bilagrid/BilagridUniformSampleBwdV1_kernel.cuh"
#include "kernels/bilagrid/BilagridUniformSampleBwdV2_kernel.cuh"
...
void bilagrid_uniform_sample_backward_v1(
    ...
    // v_coords and v_rgb
    {
        ...
        bilagrid_uniform_sample_backward_v1_kernel_rgb<<<blocks, kBilagridBwdV1RgbThreads, 0, stream>>>(
...
void bilagrid_patched_sample_backward_v1(
    ...
    // v_rgb
    {
        int total = N * m * h * w;
        int blocks = (total + kBilagridBwdV1RgbThreads - 1) / kBilagridBwdV1RgbThreads;
        bilagrid_patched_sample_backward_v1_kernel_rgb<<<blocks, kBilagridBwdV1RgbThreads, 0, stream>>>(
