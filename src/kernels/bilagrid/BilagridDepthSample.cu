#include "kernels/bilagrid/BilagridDepthSampleFwd_kernel.cuh"
#include "kernels/bilagrid/BilagridDepthSampleBwdV1_kernel.cuh"
#include "kernels/bilagrid/BilagridDepthSampleBwdV2_kernel.cuh"  // non-PATCHED scatter
