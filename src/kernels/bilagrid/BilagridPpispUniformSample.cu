#include "kernels/bilagrid/BilagridPpispUniformSampleFwd_kernel.cuh"
#include "kernels/bilagrid/BilagridPpispUniformSampleBwdV1_kernel.cuh"
#include "kernels/bilagrid/BilagridPpispUniformSampleBwdV2_kernel.cuh"  // templated, non-PATCHED
