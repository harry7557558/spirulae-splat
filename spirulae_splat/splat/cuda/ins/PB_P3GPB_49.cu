...
>(
    ...
    Vanilla3DGUT<0>::ScreenBuffer vr_splats_screen,
    Vanilla3DGUT<0>::ScreenBuffer h_splats_screen,
    // grad inputs
    Vanilla3DGUT<0>::WorldBuffer v_splats_world,
    float3* vr_world_pos_buffer,
    float3* h_world_pos_buffer,
    Vanilla3DGUT<0>::WorldBuffer vr_splats_world,
    Vanilla3DGUT<0>::WorldBuffer h_splats_world,
