...
>(
    ...
    Vanilla3DGS<0>::WorldBuffer vr_splat_wbuffer,
    Vanilla3DGS<0>::ScreenBuffer vr_splat_sbuffer,
    Vanilla3DGS<0>::WorldBuffer h_splat_wbuffer,
    Vanilla3DGS<0>::ScreenBuffer h_splat_sbuffer,
