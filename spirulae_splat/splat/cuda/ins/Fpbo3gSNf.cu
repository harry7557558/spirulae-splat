...
>(
    ...
    const uint32_t C,
    const uint32_t N,
    Vanilla3DGS::WorldBuffer splats_world,
    ...
    Vanilla3DGS::WorldBuffer v_splats_world,
    ...
    Vanilla3DGS::ScreenBuffer h_splats_screen,
    // optimizer states
    Vanilla3DGS::WorldBuffer g1_splats_world,
    Vanilla3DGS::WorldBuffer g2_splats_world,
