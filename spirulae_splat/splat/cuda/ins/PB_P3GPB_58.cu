...
>(
    ...
    Vanilla3DGUT<2>::ScreenBuffer vr_splats_screen,
    Vanilla3DGUT<2>::ScreenBuffer h_splats_screen,
    // grad inputs
    Vanilla3DGUT<2>::WorldBuffer v_splats_world,
    float3* vr_world_pos_buffer,
    float3* h_world_pos_buffer,
    Vanilla3DGUT<2>::WorldBuffer vr_splats_world,
    Vanilla3DGUT<2>::WorldBuffer h_splats_world,
...
>(
    ...
    Vanilla3DGUT<3>::ScreenBuffer vr_splats_screen,
    Vanilla3DGUT<3>::ScreenBuffer h_splats_screen,
    // grad inputs
    Vanilla3DGUT<3>::WorldBuffer v_splats_world,
    float3* vr_world_pos_buffer,
    float3* h_world_pos_buffer,
    Vanilla3DGUT<3>::WorldBuffer vr_splats_world,
    Vanilla3DGUT<3>::WorldBuffer h_splats_world,
    float * v_viewmats // [C, 4, 4] optional
);
