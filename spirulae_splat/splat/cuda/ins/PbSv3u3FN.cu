...
>(
    ...
    const uint32_t C,
    const uint32_t N,
    const SphericalVoronoi3DGUT<3>::WorldBuffer splats_world,
    ...
    // grad outputs
    SphericalVoronoi3DGUT<3>::ScreenBuffer v_splats_screen,
    SphericalVoronoi3DGUT<3>::ScreenBuffer vr_splats_screen,
    SphericalVoronoi3DGUT<3>::ScreenBuffer h_splats_screen,
    // grad inputs
    SphericalVoronoi3DGUT<3>::WorldBuffer v_splats_world,
    float3* vr_world_pos_buffer,
    float3* h_world_pos_buffer,
    SphericalVoronoi3DGUT<3>::WorldBuffer vr_splats_world,
    SphericalVoronoi3DGUT<3>::WorldBuffer h_splats_world,
