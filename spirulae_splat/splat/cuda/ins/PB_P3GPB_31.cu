...
>(
    ...
    Vanilla3DGS<3>::ScreenBuffer vr_splats_screen,
    Vanilla3DGS<3>::ScreenBuffer h_splats_screen,
    // grad inputs
    Vanilla3DGS<3>::WorldBuffer v_splats_world,
    float3* vr_world_pos_buffer,
    float3* h_world_pos_buffer,
    Vanilla3DGS<3>::WorldBuffer vr_splats_world,
    Vanilla3DGS<3>::WorldBuffer h_splats_world,
...
>(
    ...
    MipSplatting<3>::ScreenBuffer vr_splats_screen,
    MipSplatting<3>::ScreenBuffer h_splats_screen,
    // grad inputs
    MipSplatting<3>::WorldBuffer v_splats_world,
    float3* vr_world_pos_buffer,
    float3* h_world_pos_buffer,
    MipSplatting<3>::WorldBuffer vr_splats_world,
    MipSplatting<3>::WorldBuffer h_splats_world,
    float * v_viewmats // [C, 4, 4] optional
);
