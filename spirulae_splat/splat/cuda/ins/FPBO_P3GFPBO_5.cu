...
>(
    ...
    MipSplatting<0>::WorldBuffer vr_splats_world,
    MipSplatting<0>::WorldBuffer h_splats_world,
    MipSplatting<0>::ScreenBuffer v_splats_screen,
    MipSplatting<0>::ScreenBuffer vr_splats_screen,
    MipSplatting<0>::ScreenBuffer h_splats_screen,
    // optimizer states
