...
// csrc/Visualizer.cu: engine_viewer_init / set_camera_size / set_grid /
...
// work runs slang/vulkan/visualizer.slang (see its header for the
...
/* ==== API definitions matching csrc/Visualizer.cu ==== */
