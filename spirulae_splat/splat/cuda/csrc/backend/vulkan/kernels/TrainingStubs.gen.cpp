...
// from FusedProjectionBwdOptim.cuh
...
) { _vk_stub("fused_projection_bwd_optimizer_3dgs"); }
...
void fused_projection_bwd_optimizer_3dgut(
    ...
    std::variant<int32_t, TorchTensorView> step,
    int quantization_level
) { _vk_stub("fused_projection_bwd_optimizer_3dgut"); }
...
) { _vk_stub("projection_3dgs_backward"); }

// from ProjectionBwdQuantGrad.cuh
...
) { _vk_stub("projection_3dgs_backward_quantgrad"); }
...
void projection_3dgut_backward(
    ...
    const int sh_value_bits,
    const int64_t sh_bounds_stride
) { _vk_stub("projection_3dgut_backward"); }
...
void projection_3dgut_backward_quantgrad(
    ...
    const int sh_value_bits,
    const int64_t sh_value_bounds_stride
) { _vk_stub("projection_3dgut_backward_quantgrad"); }
...
void projection_mip_backward(
    ...
    const int sh_value_bits,
    const int64_t sh_bounds_stride
) { _vk_stub("projection_mip_backward"); }
