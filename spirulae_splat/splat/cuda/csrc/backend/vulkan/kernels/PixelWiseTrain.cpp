...
// (csrc/PixelWise.cuh backward subset + linear->ray depth remap) and the
// color-shift regularizer (csrc/EngineInternal.h / ColorShiftReg.cu).
// Device work: slang/vulkan/pixel_wise_train.slang. The render-path
...
// Mirrors BlendBgBwdParams in slang/vulkan/pixel_wise_train.slang.
...
/* API definitions matching csrc/PixelWise.cuh (training subset) */
...
/* color_shift_reg_step (csrc/EngineInternal.h / ColorShiftReg.cu) */
