...
// launch APIs (csrc/PixelWise.cuh PPISP subset) and the PpispInit.cu
// helpers (csrc/EngineInternal.h). Device work: slang/vulkan/
// ppisp_image.slang (canonical slang/ppisp.slang math) + the init kernels in
// bilagrid_tv.slang.
...
// Mirrors PpispImageParams in slang/vulkan/ppisp_image.slang.
