...
// ) {
//     OpaqueTriangle::WorldBuffer in_splats = in_splats_tensor;
...
//     OpaqueTriangle::ScreenBuffer splats_proj =
//         OpaqueTriangle::ScreenBuffer::allocProjFwdPacked(nnz, opt);
...
// ) {
//     OpaqueTriangle::WorldBuffer splats_world(splats_world_tuple);
//     uint32_t N = splats_world.size();  // number of splats
//     uint32_t C = viewmats.size(-3);  // number of cameras
//     uint32_t nnz = camera_ids.size(0);  // number of intersections

//     OpaqueTriangle::ScreenBuffer v_splats_proj(v_splats_proj_tuple);

//     OpaqueTriangle::WorldBuffer v_splats_world = splats_world.allocProjBwd(false);
