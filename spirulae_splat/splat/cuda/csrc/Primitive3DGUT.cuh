...
struct Vanilla3DGUT : public _BasePrimitive3DGUT<sh_degree> {
    ...
    class WorldBuffer : public _BasePrimitive3DGUT<sh_degree>::WorldBuffer {
        using _BasePrimitive3DGUT<sh_degree>::WorldBuffer::WorldBuffer;
    };
    class ScreenBuffer : public _BasePrimitive3DGUT<sh_degree>::ScreenBuffer {
        using _BasePrimitive3DGUT<sh_degree>::ScreenBuffer::ScreenBuffer;
    };
        ...
        inline __device__ void project_vjp_h_pos(
            ...
            if constexpr (camera_model == ssplat::CameraModelType::PINHOLE)
                Slang3DGS::projection_3dgut_persp_vjp(
                    ...
                    cam.width, cam.height,
                    make_float2(0), 0.0f, v_proj.scale, v_proj.opacity,
                    make_float2(0), 0.0f, vr_proj.scale, vr_proj.opacity,
                    make_float2(0), 0.0f, h_proj.scale, h_proj.opacity,
                    &v_world.mean, &v_world.quat, &v_world.scale, &v_world.opacity,
