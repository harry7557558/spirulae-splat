...
{
    DiffPair_float_0 _S16 = *dpx_6;
    float _S17 = - (*dpy_4).primal_0 / ((*dpx_6).primal_0 * (*dpx_6).primal_0 + (*dpy_4).primal_0 * (*dpy_4).primal_0) * dOut_10;
    dpx_6->primal_0 = (*dpx_6).primal_0;
    dpx_6->differential_0 = _S17;
    float _S18 = _S16.primal_0 / (_S16.primal_0 * _S16.primal_0 + (*dpy_4).primal_0 * (*dpy_4).primal_0) * dOut_10;
    dpy_4->primal_0 = (*dpy_4).primal_0;
    dpy_4->differential_0 = _S18;
    return;
}
...
inline __device__ void _d_exp_0(DiffPair_float_0 * dpx_7, float dOut_11)
{
    float _S21 = (F32_exp(((*dpx_7).primal_0))) * dOut_11;
    dpx_7->primal_0 = (*dpx_7).primal_0;
    dpx_7->differential_0 = _S21;
    return;
}
...
{
    float3  _S22 = exp_0((*dpx_8).primal_0) * dOut_12;
    dpx_8->primal_0 = (*dpx_8).primal_0;
    dpx_8->differential_0 = _S22;
    return;
}

inline __device__ void _d_log_0(DiffPair_float_0 * dpx_9, float dOut_13)
{
    float _S23 = 1.0f / (*dpx_9).primal_0 * dOut_13;
    dpx_9->primal_0 = (*dpx_9).primal_0;
    dpx_9->differential_0 = _S23;
    return;
}
...
inline __device__ void s_bwd_prop_length_impl_0(DiffPair_vectorx3Cfloatx2C2x3E_0 * dpx_10, float _s_dOut_0)
{
    float _S305 = (*dpx_10).primal_0.x;
    float _S306 = (*dpx_10).primal_0.y;
    DiffPair_float_0 _S307;
    (&_S307)->primal_0 = _S305 * _S305 + _S306 * _S306;
    (&_S307)->differential_0 = 0.0f;
    s_bwd_prop_sqrt_0(&_S307, _s_dOut_0);
    float _S308 = (*dpx_10).primal_0.y * _S307.differential_0;
    float _S309 = _S308 + _S308;
    float _S310 = (*dpx_10).primal_0.x * _S307.differential_0;
    float _S311 = _S310 + _S310;
    float2  _S312 = make_float2 (0.0f);
    *&((&_S312)->y) = _S309;
    *&((&_S312)->x) = _S311;
    dpx_10->primal_0 = (*dpx_10).primal_0;
    dpx_10->differential_0 = _S312;
    return;
}
...
{
    float _S689 = (*right_8).primal_0.rows[int(0)].x * dOut_14.x;
    Matrix<float, 3, 3>  right_d_result_4;
    *&(((&right_d_result_4)->rows + (int(0)))->x) = (*left_8).primal_0.x * dOut_14.x;
    float sum_14 = _S689 + (*right_8).primal_0.rows[int(0)].y * dOut_14.y;
    ...
    *&((&left_d_result_4)->x) = sum_15;
    float _S690 = (*right_8).primal_0.rows[int(1)].x * dOut_14.x;
    *&(((&right_d_result_4)->rows + (int(1)))->x) = (*left_8).primal_0.y * dOut_14.x;
    float sum_16 = _S690 + (*right_8).primal_0.rows[int(1)].y * dOut_14.y;
    ...
    *&((&left_d_result_4)->y) = sum_17;
    float _S691 = (*right_8).primal_0.rows[int(2)].x * dOut_14.x;
    *&(((&right_d_result_4)->rows + (int(2)))->x) = (*left_8).primal_0.z * dOut_14.x;
    float sum_18 = _S691 + (*right_8).primal_0.rows[int(2)].y * dOut_14.y;
...
{
    float _S692 = _slang_select(((*dpx_11).primal_0) > 0.0f, 1.0f,_slang_select(((*dpx_11).primal_0) == 0.0f, 0.0f,-1.0f)) * dOut_15;
    dpx_11->primal_0 = (*dpx_11).primal_0;
    dpx_11->differential_0 = _S692;
    return;
}

inline __device__ void _d_exp2_0(DiffPair_float_0 * dpx_12, float dOut_16)
{
    float _S693 = (F32_exp2(((*dpx_12).primal_0))) * 50.693145751953125f * dOut_16;
    dpx_12->primal_0 = (*dpx_12).primal_0;
    dpx_12->differential_0 = _S693;
    return;
}

inline __device__ void _d_cross_0(DiffPair_vectorx3Cfloatx2C3x3E_0 * a_4, DiffPair_vectorx3Cfloatx2C3x3E_0 * b_4, float3  dOut_17)
{
    float _S694 = dOut_17.y;
    float _S695 = dOut_17.z;
    float _S696 = dOut_17.x;
...
inline __device__ void projection_opaque_triangle_persp(float3  mean_9, float4  quat_12, float3  scale_11, float2  hardness_0, Matrix<float, 3, 3>  R_11, float3  t_10, float fx_13, float fy_13, float cx_13, float cy_13, uint image_width_9, uint image_height_9, float near_plane_6, float far_plane_6, int4  * aabb_xyxy_6, float * depth_6, float3  * normal_0, float2  * uv0_0, float2  * uv1_0, float2  * uv2_0, float2  * out_hardness_0)
{
    for(;;)
    {
        ...
        *normal_0 = _S718 * make_float3 (float(- (F32_sign((dot_0(_S718, mean_c_8))))));
...
inline __device__ void _projection_opaque_triangle_persp_differentiable(float3  mean_10, float4  quat_13, float3  scale_12, float2  hardness_1, Matrix<float, 3, 3>  R_12, float3  t_11, float fx_14, float fy_14, float cx_14, float cy_14, uint image_width_10, uint image_height_10, float near_plane_7, float far_plane_7, int4  * aabb_xyxy_7, float * depth_7, float3  * normal_1, float2  * uv0_1, float2  * uv1_1, float2  * uv2_1, float2  * out_hardness_1)
{
    ...
    *normal_1 = _S726 * make_float3 (float(- (F32_sign((dot_0(_S726, mean_c_9))))));
...
inline __device__ float s_primal_ctx_dot_0(float3  _S731, float3  _S732)
{
    return dot_0(_S731, _S732);
}

inline __device__ void s_bwd_prop_dot_0(DiffPair_vectorx3Cfloatx2C3x3E_0 * _S733, DiffPair_vectorx3Cfloatx2C3x3E_0 * _S734, float _S735)
{
    _d_dot_0(_S733, _S734, _S735);
    return;
}

inline __device__ void s_bwd_prop_length_impl_1(DiffPair_vectorx3Cfloatx2C3x3E_0 * dpx_13, float _s_dOut_1)
{
    float _S736 = (*dpx_13).primal_0.x;
    float _S737 = (*dpx_13).primal_0.y;
    float _S738 = (*dpx_13).primal_0.z;
    DiffPair_float_0 _S739;
    (&_S739)->primal_0 = _S736 * _S736 + _S737 * _S737 + _S738 * _S738;
    (&_S739)->differential_0 = 0.0f;
    s_bwd_prop_sqrt_0(&_S739, _s_dOut_1);
    float _S740 = (*dpx_13).primal_0.z * _S739.differential_0;
    float _S741 = _S740 + _S740;
    float _S742 = (*dpx_13).primal_0.y * _S739.differential_0;
    float _S743 = _S742 + _S742;
    float _S744 = (*dpx_13).primal_0.x * _S739.differential_0;
    ...
    *&((&_S746)->x) = _S745;
    ...
    dpx_13->differential_0 = _S746;
    return;
}

inline __device__ void s_bwd_length_impl_1(DiffPair_vectorx3Cfloatx2C3x3E_0 * _S747, float _S748)
{
    s_bwd_prop_length_impl_1(_S747, _S748);
    return;
}

inline __device__ void s_bwd_prop_normalize_impl_0(DiffPair_vectorx3Cfloatx2C3x3E_0 * dpx_14, float3  _s_dOut_2)
{
    float _S749 = length_1((*dpx_14).primal_0);
    float3  _S750 = (*dpx_14).primal_0 * _s_dOut_2;
    float3  _S751 = make_float3 (1.0f / _S749) * _s_dOut_2;
    float _S752 = - ((_S750.x + _S750.y + _S750.z) / (_S749 * _S749));
    float3  _S753 = make_float3 (0.0f);
    DiffPair_vectorx3Cfloatx2C3x3E_0 _S754;
    (&_S754)->primal_0 = (*dpx_14).primal_0;
    (&_S754)->differential_0 = _S753;
    s_bwd_length_impl_1(&_S754, _S752);
    float3  _S755 = _S751 + _S754.differential_0;
    dpx_14->primal_0 = (*dpx_14).primal_0;
    dpx_14->differential_0 = _S755;
    return;
}

inline __device__ void s_bwd_normalize_impl_0(DiffPair_vectorx3Cfloatx2C3x3E_0 * _S756, float3  _S757)
{
    s_bwd_prop_normalize_impl_0(_S756, _S757);
    return;
}

inline __device__ void s_bwd_prop_cross_0(DiffPair_vectorx3Cfloatx2C3x3E_0 * _S758, DiffPair_vectorx3Cfloatx2C3x3E_0 * _S759, float3  _S760)
{
    _d_cross_0(_S758, _S759, _S760);
    return;
}

inline __device__ void s_bwd_prop_exp2_0(DiffPair_float_0 * _S761, float _S762)
{
    _d_exp2_0(_S761, _S762);
    return;
}

inline __device__ void s_bwd_prop_abs_0(DiffPair_float_0 * _S763, float _S764)
{
    _d_abs_0(_S763, _S764);
    return;
}

inline __device__ void s_bwd_prop_mul_4(DiffPair_vectorx3Cfloatx2C3x3E_0 * _S765, DiffPair_matrixx3Cfloatx2C3x2C3x3E_0 * _S766, float3  _S767)
{
    _d_mul_1(_S765, _S766, _S767);
    return;
}
...
{
    float3  mean_c_10 = s_primal_ctx_mul_0(R_13, mean_11) + t_12;
    float3  _S768 = s_primal_ctx_exp_0(scale_13);
    float _S769 = quat_14.y;
    float _S770 = _S769 * _S769 + quat_14.z * quat_14.z + quat_14.w * quat_14.w + quat_14.x * quat_14.x;
    float _S771 = s_primal_ctx_rsqrt_0(_S770);
    float x_35 = quat_14.y * _S771;
    float y_16 = quat_14.z * _S771;
    float z_14 = quat_14.w * _S771;
    float w_14 = quat_14.x * _S771;
    ...
    Matrix<float, 3, 3>  _S772 = transpose_0(makeMatrix<float, 3, 3> (1.0f - 2.0f * (y2_18 + z2_14), 2.0f * (xy_18 + wz_14), 2.0f * (xz_14 - wy_14), 2.0f * (xy_18 - wz_14), 1.0f - 2.0f * (x2_18 + z2_14), 2.0f * (yz_14 + wx_14), 2.0f * (xz_14 + wy_14), 2.0f * (yz_14 - wx_14), 1.0f - 2.0f * (x2_18 + y2_18)));
    Matrix<float, 3, 3>  S_3 = makeMatrix<float, 3, 3> (_S768.x, 0.0f, 0.0f, 0.0f, _S768.y, 0.0f, 0.0f, 0.0f, _S768.z);
    Matrix<float, 3, 3>  _S773 = s_primal_ctx_mul_1(_S772, S_3);
    float3  _S774 = make_float3 (1.0f, 0.0f, 0.0f);
    float3  vert0_2 = s_primal_ctx_mul_4(_S774, _S773) + mean_11;
    float _S775 = s_primal_ctx_sqrt_0(0.75f);
    float3  _S776 = make_float3 (-0.5f, _S775, 0.0f);
    float3  vert1_2 = s_primal_ctx_mul_4(_S776, _S773) + mean_11;
    float3  _S777 = make_float3 (-0.5f, - _S775, 0.0f);
    float3  vert2_2 = s_primal_ctx_mul_4(_S777, _S773) + mean_11;
    ...
    float2  _S778 = float2 {vert0_c_2.x, vert0_c_2.y};
    float _S779 = vert0_c_2.z;
    float2  _S780 = make_float2 (_S779);
    float2  _S781 = make_float2 (_S779 * _S779);
    float2  _S782 = float2 {vert1_c_2.x, vert1_c_2.y};
    float _S783 = vert1_c_2.z;
    float2  _S784 = make_float2 (_S783);
    float2  _S785 = make_float2 (_S783 * _S783);
    float2  _S786 = float2 {vert2_c_2.x, vert2_c_2.y};
    float _S787 = vert2_c_2.z;
    float2  _S788 = make_float2 (_S787);
    float2  _S789 = make_float2 (_S787 * _S787);
    float2  _S790 = make_float2 (fx_15, fy_15);
    float2  _S791 = make_float2 (cx_15, cy_15);
    float2  _S792 = _S790 * (_S778 / make_float2 (_S779)) + _S791;
    float2  _S793 = _S790 * (_S782 / make_float2 (_S783)) + _S791;
    float2  _S794 = _S790 * (_S786 / make_float2 (_S787)) + _S791;
    float2  e0_2 = _S793 - _S792;
    float2  e1_2 = _S794 - _S793;
    float2  e2_0 = _S792 - _S794;
    float _S795 = e0_2.x;
    float _S796 = e1_2.y;
    float _S797 = e0_2.y;
    float _S798 = e1_2.x;
    float _S799 = _S795 * _S796 - _S797 * _S798;
    float _S800 = 1.0f - hardness_2.y;
    float _S801 = -1.0f / _S800;
    float _S802 = _S800 * _S800;
    float _S803 = _S792.x;
    float _S804 = _S793.x;
    ...
    float _S808 = _S792.y;
    float _S809 = _S793.y;
    float _S810 = s_primal_ctx_max_0(_S808, _S809);
    float _S811 = _S794.y;
    float _S812 = s_primal_ctx_min_0(_S808, _S809);
    float3  _S813 = vert1_2 - vert0_2;
    float3  _S814 = vert2_2 - vert0_2;
    float3  _S815 = s_primal_ctx_cross_0(_S813, _S814);
    float3  _S816 = s_primal_ctx_mul_0(R_13, _S815);
    float3  _S817 = normalize_0(_S816);
    float3  _S818 = make_float3 (float(- (F32_sign((s_primal_ctx_dot_0(_S817, mean_c_10)))))) * v_normal_0;
    float3  _S819 = make_float3 (0.0f);
    DiffPair_vectorx3Cfloatx2C3x3E_0 _S820;
    (&_S820)->primal_0 = _S817;
    (&_S820)->differential_0 = _S819;
    DiffPair_vectorx3Cfloatx2C3x3E_0 _S821;
    (&_S821)->primal_0 = mean_c_10;
    (&_S821)->differential_0 = _S819;
    s_bwd_prop_dot_0(&_S820, &_S821, 0.0f);
    float3  _S822 = _S818 + _S820.differential_0;
    DiffPair_vectorx3Cfloatx2C3x3E_0 _S823;
    (&_S823)->primal_0 = _S816;
    (&_S823)->differential_0 = _S819;
    s_bwd_normalize_impl_0(&_S823, _S822);
    Matrix<float, 3, 3>  _S824 = makeMatrix<float, 3, 3> (0.0f);
    DiffPair_matrixx3Cfloatx2C3x2C3x3E_0 _S825;
    (&_S825)->primal_0 = R_13;
    (&_S825)->differential_0 = _S824;
    DiffPair_vectorx3Cfloatx2C3x3E_0 _S826;
    (&_S826)->primal_0 = _S815;
    (&_S826)->differential_0 = _S819;
    s_bwd_prop_mul_3(&_S825, &_S826, _S823.differential_0);
    DiffPair_vectorx3Cfloatx2C3x3E_0 _S827;
    (&_S827)->primal_0 = _S813;
    (&_S827)->differential_0 = _S819;
    DiffPair_vectorx3Cfloatx2C3x3E_0 _S828;
    (&_S828)->primal_0 = _S814;
    (&_S828)->differential_0 = _S819;
    s_bwd_prop_cross_0(&_S827, &_S828, _S826.differential_0);
    float3  _S829 = - _S828.differential_0;
    float3  _S830 = - _S827.differential_0;
    DiffPair_float_0 _S831;
    (&_S831)->primal_0 = _S812;
    (&_S831)->differential_0 = 0.0f;
    DiffPair_float_0 _S832;
    (&_S832)->primal_0 = _S811;
    (&_S832)->differential_0 = 0.0f;
    s_bwd_prop_min_0(&_S831, &_S832, 0.0f);
    DiffPair_float_0 _S833;
    (&_S833)->primal_0 = _S808;
    (&_S833)->differential_0 = 0.0f;
    DiffPair_float_0 _S834;
    (&_S834)->primal_0 = _S809;
    (&_S834)->differential_0 = 0.0f;
    s_bwd_prop_min_0(&_S833, &_S834, _S831.differential_0);
    DiffPair_float_0 _S835;
    (&_S835)->primal_0 = _S810;
    (&_S835)->differential_0 = 0.0f;
    DiffPair_float_0 _S836;
    (&_S836)->primal_0 = _S811;
    (&_S836)->differential_0 = 0.0f;
    s_bwd_prop_max_0(&_S835, &_S836, 0.0f);
    float _S837 = _S832.differential_0 + _S836.differential_0;
    DiffPair_float_0 _S838;
    (&_S838)->primal_0 = _S808;
    (&_S838)->differential_0 = 0.0f;
    DiffPair_float_0 _S839;
    (&_S839)->primal_0 = _S809;
    (&_S839)->differential_0 = 0.0f;
    s_bwd_prop_max_0(&_S838, &_S839, _S835.differential_0);
    float _S840 = _S834.differential_0 + _S839.differential_0;
    float _S841 = _S833.differential_0 + _S838.differential_0;
    DiffPair_float_0 _S842;
    (&_S842)->primal_0 = _S807;
    (&_S842)->differential_0 = 0.0f;
    DiffPair_float_0 _S843;
    (&_S843)->primal_0 = _S806;
    (&_S843)->differential_0 = 0.0f;
    s_bwd_prop_min_0(&_S842, &_S843, 0.0f);
    DiffPair_float_0 _S844;
    (&_S844)->primal_0 = _S803;
    (&_S844)->differential_0 = 0.0f;
    DiffPair_float_0 _S845;
    (&_S845)->primal_0 = _S804;
    (&_S845)->differential_0 = 0.0f;
    s_bwd_prop_min_0(&_S844, &_S845, _S842.differential_0);
    DiffPair_float_0 _S846;
    (&_S846)->primal_0 = _S805;
    (&_S846)->differential_0 = 0.0f;
    DiffPair_float_0 _S847;
    (&_S847)->primal_0 = _S806;
    (&_S847)->differential_0 = 0.0f;
    s_bwd_prop_max_0(&_S846, &_S847, 0.0f);
    float _S848 = _S843.differential_0 + _S847.differential_0;
    DiffPair_float_0 _S849;
    (&_S849)->primal_0 = _S803;
    (&_S849)->differential_0 = 0.0f;
    DiffPair_float_0 _S850;
    (&_S850)->primal_0 = _S804;
    (&_S850)->differential_0 = 0.0f;
    s_bwd_prop_max_0(&_S849, &_S850, _S846.differential_0);
    float _S851 = _S845.differential_0 + _S850.differential_0;
    float _S852 = _S844.differential_0 + _S849.differential_0;
    DiffPair_float_0 _S853;
    (&_S853)->primal_0 = _S801;
    (&_S853)->differential_0 = 0.0f;
    s_bwd_prop_exp2_0(&_S853, 0.0f);
    float _S854 = - (-1.0f * - (_S853.differential_0 / _S802));
    float2  _S855 = make_float2 (0.0f);
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S856;
    (&_S856)->primal_0 = e2_0;
    (&_S856)->differential_0 = _S855;
    s_bwd_length_impl_0(&_S856, -0.0f);
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S857;
    (&_S857)->primal_0 = e1_2;
    (&_S857)->differential_0 = _S855;
    s_bwd_length_impl_0(&_S857, -0.0f);
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S858;
    (&_S858)->primal_0 = e0_2;
    (&_S858)->differential_0 = _S855;
    s_bwd_length_impl_0(&_S858, -0.0f);
    DiffPair_float_0 _S859;
    (&_S859)->primal_0 = _S799;
    (&_S859)->differential_0 = 0.0f;
    s_bwd_prop_abs_0(&_S859, 0.0f);
    float _S860 = - _S859.differential_0;
    float2  _S861 = _S857.differential_0 + make_float2 (_S797 * _S860, _S795 * _S859.differential_0);
    float2  _S862 = _S858.differential_0 + make_float2 (_S796 * _S859.differential_0, _S798 * _S860);
    float2  _S863 = _S790 * (v_uv2_0 + - _S856.differential_0 + _S861 + make_float2 (_S848, _S837)) / _S789;
    float2  _S864 = _S786 * - _S863;
    float2  _S865 = _S788 * _S863;
    float2  _S866 = _S790 * (v_uv1_0 + - _S861 + _S862 + make_float2 (_S851, _S840)) / _S785;
    float2  _S867 = _S782 * - _S866;
    float2  _S868 = _S784 * _S866;
    float _S869 = _S867.x + _S867.y;
    float2  _S870 = _S790 * (v_uv0_0 + _S856.differential_0 + - _S862 + make_float2 (_S852, _S841)) / _S781;
    float2  _S871 = _S778 * - _S870;
    float2  _S872 = _S780 * _S870;
    float _S873 = _S871.x + _S871.y;
    float3  s_diff_vert2_c_T_0 = make_float3 (_S865.x, _S865.y, _S864.x + _S864.y);
    DiffPair_matrixx3Cfloatx2C3x2C3x3E_0 _S874;
    (&_S874)->primal_0 = R_13;
    (&_S874)->differential_0 = _S824;
    DiffPair_vectorx3Cfloatx2C3x3E_0 _S875;
    (&_S875)->primal_0 = vert2_2;
    (&_S875)->differential_0 = _S819;
    s_bwd_prop_mul_3(&_S874, &_S875, s_diff_vert2_c_T_0);
    float3  s_diff_vert1_c_T_0 = make_float3 (_S868.x, _S868.y, _S869);
    DiffPair_matrixx3Cfloatx2C3x2C3x3E_0 _S876;
    (&_S876)->primal_0 = R_13;
    (&_S876)->differential_0 = _S824;
    DiffPair_vectorx3Cfloatx2C3x3E_0 _S877;
    (&_S877)->primal_0 = vert1_2;
    (&_S877)->differential_0 = _S819;
    s_bwd_prop_mul_3(&_S876, &_S877, s_diff_vert1_c_T_0);
    float3  s_diff_vert0_c_T_0 = make_float3 (_S872.x, _S872.y, _S873);
    DiffPair_matrixx3Cfloatx2C3x2C3x3E_0 _S878;
    (&_S878)->primal_0 = R_13;
    (&_S878)->differential_0 = _S824;
    DiffPair_vectorx3Cfloatx2C3x3E_0 _S879;
    (&_S879)->primal_0 = vert0_2;
    (&_S879)->differential_0 = _S819;
    s_bwd_prop_mul_3(&_S878, &_S879, s_diff_vert0_c_T_0);
    float3  _S880 = _S828.differential_0 + _S875.differential_0;
    DiffPair_vectorx3Cfloatx2C3x3E_0 _S881;
    (&_S881)->primal_0 = _S777;
    (&_S881)->differential_0 = _S819;
    DiffPair_matrixx3Cfloatx2C3x2C3x3E_0 _S882;
    (&_S882)->primal_0 = _S773;
    (&_S882)->differential_0 = _S824;
    s_bwd_prop_mul_4(&_S881, &_S882, _S880);
    float3  _S883 = _S827.differential_0 + _S877.differential_0;
    DiffPair_vectorx3Cfloatx2C3x3E_0 _S884;
    (&_S884)->primal_0 = _S776;
    (&_S884)->differential_0 = _S819;
    DiffPair_matrixx3Cfloatx2C3x2C3x3E_0 _S885;
    (&_S885)->primal_0 = _S773;
    (&_S885)->differential_0 = _S824;
    s_bwd_prop_mul_4(&_S884, &_S885, _S883);
    float3  _S886 = _S829 + _S830 + _S879.differential_0;
    DiffPair_vectorx3Cfloatx2C3x3E_0 _S887;
    (&_S887)->primal_0 = _S774;
    (&_S887)->differential_0 = _S819;
    DiffPair_matrixx3Cfloatx2C3x2C3x3E_0 _S888;
    (&_S888)->primal_0 = _S773;
    (&_S888)->differential_0 = _S824;
    s_bwd_prop_mul_4(&_S887, &_S888, _S886);
    Matrix<float, 3, 3>  _S889 = _S882.differential_0 + _S885.differential_0 + _S888.differential_0;
    DiffPair_matrixx3Cfloatx2C3x2C3x3E_0 _S890;
    (&_S890)->primal_0 = _S772;
    (&_S890)->differential_0 = _S824;
    DiffPair_matrixx3Cfloatx2C3x2C3x3E_0 _S891;
    (&_S891)->primal_0 = S_3;
    (&_S891)->differential_0 = _S824;
    s_bwd_prop_mul_2(&_S890, &_S891, _S889);
    Matrix<float, 3, 3>  _S892 = transpose_0(_S890.differential_0);
    float _S893 = 2.0f * - _S892.rows[int(2)].z;
    float _S894 = 2.0f * _S892.rows[int(2)].y;
    float _S895 = 2.0f * _S892.rows[int(2)].x;
    float _S896 = 2.0f * _S892.rows[int(1)].z;
    float _S897 = 2.0f * - _S892.rows[int(1)].y;
    float _S898 = 2.0f * _S892.rows[int(1)].x;
    float _S899 = 2.0f * _S892.rows[int(0)].z;
    float _S900 = 2.0f * _S892.rows[int(0)].y;
    float _S901 = 2.0f * - _S892.rows[int(0)].x;
    float _S902 = - _S898 + _S900;
    float _S903 = _S895 + - _S899;
    float _S904 = - _S894 + _S896;
    float _S905 = _S894 + _S896;
    float _S906 = _S895 + _S899;
    float _S907 = _S898 + _S900;
    float _S908 = z_14 * (_S897 + _S901);
    float _S909 = y_16 * (_S893 + _S901);
    float _S910 = x_35 * (_S893 + _S897);
    float _S911 = z_14 * _S902 + y_16 * _S903 + x_35 * _S904;
    float _S912 = _S771 * _S911;
    float _S913 = w_14 * _S902 + y_16 * _S905 + x_35 * _S906 + _S908 + _S908;
    float _S914 = _S771 * _S913;
    float _S915 = w_14 * _S903 + z_14 * _S905 + x_35 * _S907 + _S909 + _S909;
    float _S916 = _S771 * _S915;
    float _S917 = w_14 * _S904 + z_14 * _S906 + y_16 * _S907 + _S910 + _S910;
    float _S918 = _S771 * _S917;
    float _S919 = quat_14.x * _S911 + quat_14.w * _S913 + quat_14.z * _S915 + quat_14.y * _S917;
    DiffPair_float_0 _S920;
    (&_S920)->primal_0 = _S770;
    (&_S920)->differential_0 = 0.0f;
    s_bwd_prop_rsqrt_0(&_S920, _S919);
    float _S921 = quat_14.x * _S920.differential_0;
    float _S922 = quat_14.w * _S920.differential_0;
    float _S923 = quat_14.z * _S920.differential_0;
    float _S924 = quat_14.y * _S920.differential_0;
    float _S925 = _S914 + _S922 + _S922;
    float _S926 = _S916 + _S923 + _S923;
    float _S927 = _S918 + _S924 + _S924;
    float _S928 = _S912 + _S921 + _S921;
    float3  _S929 = _S819;
    *&((&_S929)->z) = _S891.differential_0.rows[int(2)].z;
    *&((&_S929)->y) = _S891.differential_0.rows[int(1)].y;
    *&((&_S929)->x) = _S891.differential_0.rows[int(0)].x;
    DiffPair_vectorx3Cfloatx2C3x3E_0 _S930;
    (&_S930)->primal_0 = scale_13;
    (&_S930)->differential_0 = _S819;
    s_bwd_prop_exp_1(&_S930, _S929);
    float3  _S931 = _S821.differential_0 + make_float3 (0.0f, 0.0f, v_depth_3);
    DiffPair_matrixx3Cfloatx2C3x2C3x3E_0 _S932;
    (&_S932)->primal_0 = R_13;
    (&_S932)->differential_0 = _S824;
    DiffPair_vectorx3Cfloatx2C3x3E_0 _S933;
    (&_S933)->primal_0 = mean_11;
    (&_S933)->differential_0 = _S819;
    s_bwd_prop_mul_3(&_S932, &_S933, _S931);
    float3  _S934 = s_diff_vert2_c_T_0 + s_diff_vert1_c_T_0 + s_diff_vert0_c_T_0 + _S931;
    Matrix<float, 3, 3>  _S935 = _S825.differential_0 + _S874.differential_0 + _S876.differential_0 + _S878.differential_0 + _S932.differential_0;
    float2  _S936 = v_out_hardness_0 + make_float2 (0.0f, _S854);
    float4  _S937 = make_float4 (0.0f);
    *&((&_S937)->w) = _S925;
    *&((&_S937)->z) = _S926;
    *&((&_S937)->y) = _S927;
    *&((&_S937)->x) = _S928;
    *v_mean_3 = _S880 + _S883 + _S886 + _S933.differential_0;
    *v_quat_3 = _S937;
    *v_scale_3 = _S930.differential_0;
    *v_hardness_0 = _S936;
    *v_R_3 = _S935;
    *v_t_3 = _S934;
    return;
...
{
    DiffPair_float_0 _S938 = *dpx_15;
    bool _S939;
    if(((*dpx_15).primal_0) >= ((*dpMin_0).primal_0))
    {
        _S939 = ((*dpx_15).primal_0) <= ((*dpMax_0).primal_0);
    }
    else
    {
        _S939 = false;
    ...
    dpx_15->primal_0 = _S938.primal_0;
    dpx_15->differential_0 = _S940;
    DiffPair_float_0 _S941 = *dpMin_0;
    if((_S938.primal_0) < ((*dpMin_0).primal_0))
    {
        _S940 = dOut_18;
    }
    else
    ...
    dpMin_0->primal_0 = _S941.primal_0;
    dpMin_0->differential_0 = _S940;
    DiffPair_float_0 _S942 = *dpMax_0;
    ...
    dpMax_0->primal_0 = _S942.primal_0;
    dpMax_0->differential_0 = _S940;
    return;
}
...
inline __device__ void _d_pow_0(DiffPair_float_0 * dpx_16, DiffPair_float_0 * dpy_5, float dOut_19)
{
    ...
    else
    {
        ...
        DiffPair_float_0 _S943 = *dpx_16;
        float _S944 = val_0 * (*dpy_5).primal_0 / (*dpx_16).primal_0 * dOut_19;
        dpx_16->primal_0 = (*dpx_16).primal_0;
        dpx_16->differential_0 = _S944;
        float _S945 = val_0 * (F32_log((_S943.primal_0))) * dOut_19;
        dpy_5->primal_0 = (*dpy_5).primal_0;
        dpy_5->differential_0 = _S945;
    }
    return;
}
...
inline __device__ float evaluate_alpha_opaque_triangle_fast(float2  v0_0, float2  v1_0, float2  v2_0, float2  hardness_3, float2  p_0)
{
    ...
    float _S946 = e0_3.x * e1_3.y - e0_3.y * e1_3.x;
    float se_0 = float((F32_sign((_S946))));
    float2  _S947 = p_0 - v0_0;
    float2  _S948 = normalize_1(e0_3);
    float2  _S949 = p_0 - v1_0;
    float2  _S950 = normalize_1(e1_3);
    float2  _S951 = p_0 - v2_0;
    float2  _S952 = normalize_1(e2_1);
    float _S953 = hardness_3.x;
    float _S954 = 1.0f - clamp_0(hardness_3.y, 0.00499999988824129f, 0.99500000476837158f);
    float a_5 = 1.0f - (1.0f + (F32_max(((F32_max((se_0 * (_S947.x * _S948.y - _S947.y * _S948.x)), (se_0 * (_S949.x * _S950.y - _S949.y * _S950.x))))), (se_0 * (_S951.x * _S952.y - _S951.y * _S952.x)))) / ((F32_abs((_S946))) / (length_0(e0_3) + length_0(e1_3) + length_0(e2_1)))) * (1.0f - (F32_exp2((-1.0f / _S954))));
    float _S955;
    if(a_5 <= 0.0f)
    {
        _S955 = 0.0f;
    ...
    {
        _S955 = (F32_min(((F32_pow((a_5), (_S954)))), (0.99900001287460327f)));
    }
    return _S953 * _S955;
}

inline __device__ float s_primal_ctx_abs_0(float _S956)
{
    return (F32_abs((_S956)));
}

inline __device__ float s_primal_ctx_clamp_0(float _S957, float _S958, float _S959)
{
    return clamp_0(_S957, _S958, _S959);
}

inline __device__ float s_primal_ctx_exp2_0(float _S960)
{
    return (F32_exp2((_S960)));
}

inline __device__ float s_primal_ctx_pow_0(float _S961, float _S962)
{
    return (F32_pow((_S961), (_S962)));
}

inline __device__ void s_bwd_prop_pow_0(DiffPair_float_0 * _S963, DiffPair_float_0 * _S964, float _S965)
{
    _d_pow_0(_S963, _S964, _S965);
    return;
}

inline __device__ void s_bwd_prop_clamp_0(DiffPair_float_0 * _S966, DiffPair_float_0 * _S967, DiffPair_float_0 * _S968, float _S969)
{
    _d_clamp_0(_S966, _S967, _S968, _S969);
    return;
}

inline __device__ void s_bwd_prop_normalize_impl_1(DiffPair_vectorx3Cfloatx2C2x3E_0 * dpx_17, float2  _s_dOut_3)
{
    float _S970 = length_0((*dpx_17).primal_0);
    float2  _S971 = (*dpx_17).primal_0 * _s_dOut_3;
    float2  _S972 = make_float2 (1.0f / _S970) * _s_dOut_3;
    float _S973 = - ((_S971.x + _S971.y) / (_S970 * _S970));
    float2  _S974 = make_float2 (0.0f);
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S975;
    (&_S975)->primal_0 = (*dpx_17).primal_0;
    (&_S975)->differential_0 = _S974;
    s_bwd_length_impl_0(&_S975, _S973);
    float2  _S976 = _S972 + _S975.differential_0;
    dpx_17->primal_0 = (*dpx_17).primal_0;
    dpx_17->differential_0 = _S976;
    return;
}

inline __device__ void s_bwd_normalize_impl_1(DiffPair_vectorx3Cfloatx2C2x3E_0 * _S977, float2  _S978)
{
    s_bwd_prop_normalize_impl_1(_S977, _S978);
    return;
}
...
inline __device__ void s_bwd_prop_evaluate_alpha_opaque_triangle_fast_0(DiffPair_vectorx3Cfloatx2C2x3E_0 * dpv0_0, DiffPair_vectorx3Cfloatx2C2x3E_0 * dpv1_0, DiffPair_vectorx3Cfloatx2C2x3E_0 * dpv2_0, DiffPair_vectorx3Cfloatx2C2x3E_0 * dphardness_0, float2  p_1, float _s_dOut_4)
{
    ...
    float _S981 = e0_4.y;
    float _S982 = e1_4.x;
    float _S983 = _S979 * _S980 - _S981 * _S982;
    float se_1 = float((F32_sign((_S983))));
    float2  _S984 = p_1 - (*dpv0_0).primal_0;
    float2  _S985 = normalize_1(e0_4);
    float _S986 = _S984.x;
    float _S987 = _S985.y;
    float _S988 = _S984.y;
    float _S989 = _S985.x;
    float de0_0 = se_1 * (_S986 * _S987 - _S988 * _S989);
    float2  _S990 = p_1 - (*dpv1_0).primal_0;
    float2  _S991 = normalize_1(e1_4);
    float _S992 = _S990.x;
    float _S993 = _S991.y;
    float _S994 = _S990.y;
    float _S995 = _S991.x;
    float de1_0 = se_1 * (_S992 * _S993 - _S994 * _S995);
    float2  _S996 = p_1 - (*dpv2_0).primal_0;
    float2  _S997 = normalize_1(e2_2);
    float _S998 = _S996.x;
    float _S999 = _S997.y;
    float _S1000 = _S996.y;
    float _S1001 = _S997.x;
    float de2_0 = se_1 * (_S998 * _S999 - _S1000 * _S1001);
    float _S1002 = s_primal_ctx_max_0(de0_0, de1_0);
    float _S1003 = s_primal_ctx_max_0(_S1002, de2_0);
    float _S1004 = s_primal_ctx_abs_0(_S983);
    float _S1005 = length_0(e0_4) + length_0(e1_4) + length_0(e2_2);
    float dmax_0 = _S1004 / _S1005;
    float _S1006 = _S1005 * _S1005;
    float _S1007 = (*dphardness_0).primal_0.x;
    float _S1008 = (*dphardness_0).primal_0.y;
    float _S1009 = dmax_0 * dmax_0;
    float _S1010 = 1.0f + _S1003 / dmax_0;
    float _S1011 = 1.0f - s_primal_ctx_clamp_0(_S1008, 0.00499999988824129f, 0.99500000476837158f);
    float _S1012 = -1.0f / _S1011;
    float _S1013 = _S1011 * _S1011;
    float _S1014 = 1.0f - s_primal_ctx_exp2_0(_S1012);
    float a_6 = 1.0f - _S1010 * _S1014;
    bool _S1015 = a_6 <= 0.0f;
    float _S1016;
    float _S1017;
    if(_S1015)
    {
    ...
    {
        float _S1018 = s_primal_ctx_pow_0(a_6, _S1011);
        _S1016 = s_primal_ctx_min_0(_S1018, 0.99900001287460327f);
        _S1017 = _S1018;
    }
    float _S1019 = _S1007 * _s_dOut_4;
    float _S1020 = _S1016 * _s_dOut_4;
    if(_S1015)
    {
        _S1016 = 0.0f;
        _S1017 = 0.0f;
    ...
    else
    {
        ...
        (&_S1021)->primal_0 = _S1017;
        (&_S1021)->differential_0 = 0.0f;
        DiffPair_float_0 _S1022;
        (&_S1022)->primal_0 = 0.99900001287460327f;
        (&_S1022)->differential_0 = 0.0f;
        s_bwd_prop_min_0(&_S1021, &_S1022, _S1019);
        DiffPair_float_0 _S1023;
        (&_S1023)->primal_0 = a_6;
        (&_S1023)->differential_0 = 0.0f;
        DiffPair_float_0 _S1024;
        (&_S1024)->primal_0 = _S1011;
        (&_S1024)->differential_0 = 0.0f;
        s_bwd_prop_pow_0(&_S1023, &_S1024, _S1021.differential_0);
        _S1016 = _S1023.differential_0;
        _S1017 = _S1024.differential_0;
    }
    float _S1025 = - _S1016;
    float _S1026 = _S1014 * _S1025;
    float _S1027 = - (_S1010 * _S1025);
    DiffPair_float_0 _S1028;
    (&_S1028)->primal_0 = _S1012;
    (&_S1028)->differential_0 = 0.0f;
    s_bwd_prop_exp2_0(&_S1028, _S1027);
    float _S1029 = - (-1.0f * - (_S1028.differential_0 / _S1013) + _S1017);
    float _S1030 = _S1026 / _S1009;
    float s_diff_dmax_T_0 = _S1003 * - _S1030;
    float _S1031 = dmax_0 * _S1030;
    DiffPair_float_0 _S1032;
    (&_S1032)->primal_0 = _S1008;
    (&_S1032)->differential_0 = 0.0f;
    DiffPair_float_0 _S1033;
    (&_S1033)->primal_0 = 0.00499999988824129f;
    (&_S1033)->differential_0 = 0.0f;
    DiffPair_float_0 _S1034;
    (&_S1034)->primal_0 = 0.99500000476837158f;
    (&_S1034)->differential_0 = 0.0f;
    s_bwd_prop_clamp_0(&_S1032, &_S1033, &_S1034, _S1029);
    float _S1035 = s_diff_dmax_T_0 / _S1006;
    float _S1036 = _S1004 * - _S1035;
    float _S1037 = _S1005 * _S1035;
    float2  _S1038 = make_float2 (0.0f);
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1039;
    (&_S1039)->primal_0 = e2_2;
    (&_S1039)->differential_0 = _S1038;
    s_bwd_length_impl_0(&_S1039, _S1036);
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1040;
    (&_S1040)->primal_0 = e1_4;
    (&_S1040)->differential_0 = _S1038;
    s_bwd_length_impl_0(&_S1040, _S1036);
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1041;
    (&_S1041)->primal_0 = e0_4;
    (&_S1041)->differential_0 = _S1038;
    s_bwd_length_impl_0(&_S1041, _S1036);
    DiffPair_float_0 _S1042;
    (&_S1042)->primal_0 = _S983;
    (&_S1042)->differential_0 = 0.0f;
    s_bwd_prop_abs_0(&_S1042, _S1037);
    DiffPair_float_0 _S1043;
    (&_S1043)->primal_0 = _S1002;
    (&_S1043)->differential_0 = 0.0f;
    DiffPair_float_0 _S1044;
    (&_S1044)->primal_0 = de2_0;
    (&_S1044)->differential_0 = 0.0f;
    s_bwd_prop_max_0(&_S1043, &_S1044, _S1031);
    DiffPair_float_0 _S1045;
    (&_S1045)->primal_0 = de0_0;
    (&_S1045)->differential_0 = 0.0f;
    DiffPair_float_0 _S1046;
    (&_S1046)->primal_0 = de1_0;
    (&_S1046)->differential_0 = 0.0f;
    s_bwd_prop_max_0(&_S1045, &_S1046, _S1043.differential_0);
    float _S1047 = se_1 * _S1044.differential_0;
    float _S1048 = - _S1047;
    float _S1049 = _S1001 * _S1048;
    float _S1050 = _S999 * _S1047;
    float2  _S1051 = make_float2 (_S1000 * _S1048, _S998 * _S1047);
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1052;
    (&_S1052)->primal_0 = e2_2;
    (&_S1052)->differential_0 = _S1038;
    s_bwd_normalize_impl_1(&_S1052, _S1051);
    float2  _S1053 = - make_float2 (_S1050, _S1049);
    float _S1054 = se_1 * _S1046.differential_0;
    float _S1055 = - _S1054;
    float _S1056 = _S995 * _S1055;
    float _S1057 = _S993 * _S1054;
    float2  _S1058 = make_float2 (_S994 * _S1055, _S992 * _S1054);
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1059;
    (&_S1059)->primal_0 = e1_4;
    (&_S1059)->differential_0 = _S1038;
    s_bwd_normalize_impl_1(&_S1059, _S1058);
    float2  _S1060 = - make_float2 (_S1057, _S1056);
    float _S1061 = se_1 * _S1045.differential_0;
    float _S1062 = - _S1061;
    float _S1063 = _S989 * _S1062;
    float _S1064 = _S987 * _S1061;
    float2  _S1065 = make_float2 (_S988 * _S1062, _S986 * _S1061);
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1066;
    (&_S1066)->primal_0 = e0_4;
    (&_S1066)->differential_0 = _S1038;
    s_bwd_normalize_impl_1(&_S1066, _S1065);
    float2  _S1067 = - make_float2 (_S1064, _S1063);
    float _S1068 = - _S1042.differential_0;
    float2  _S1069 = _S1039.differential_0 + _S1052.differential_0;
    float2  _S1070 = - _S1069;
    float2  _S1071 = _S1040.differential_0 + _S1059.differential_0 + make_float2 (_S981 * _S1068, _S979 * _S1042.differential_0);
    float2  _S1072 = - _S1071;
    float2  _S1073 = _S1041.differential_0 + _S1066.differential_0 + make_float2 (_S980 * _S1042.differential_0, _S982 * _S1068);
    float2  _S1074 = - _S1073;
    float2  _S1075 = make_float2 (_S1020, _S1032.differential_0);
    dphardness_0->primal_0 = (*dphardness_0).primal_0;
    dphardness_0->differential_0 = _S1075;
    float2  _S1076 = _S1053 + _S1070 + _S1071;
    dpv2_0->primal_0 = (*dpv2_0).primal_0;
    dpv2_0->differential_0 = _S1076;
    float2  _S1077 = _S1060 + _S1072 + _S1073;
    dpv1_0->primal_0 = (*dpv1_0).primal_0;
    dpv1_0->differential_0 = _S1077;
    float2  _S1078 = _S1067 + _S1069 + _S1074;
    dpv0_0->primal_0 = (*dpv0_0).primal_0;
    dpv0_0->differential_0 = _S1078;
    return;
}

inline __device__ void s_bwd_evaluate_alpha_opaque_triangle_fast_0(DiffPair_vectorx3Cfloatx2C2x3E_0 * _S1079, DiffPair_vectorx3Cfloatx2C2x3E_0 * _S1080, DiffPair_vectorx3Cfloatx2C2x3E_0 * _S1081, DiffPair_vectorx3Cfloatx2C2x3E_0 * _S1082, float2  _S1083, float _S1084)
{
    s_bwd_prop_evaluate_alpha_opaque_triangle_fast_0(_S1079, _S1080, _S1081, _S1082, _S1083, _S1084);
    return;
}
...
inline __device__ float evaluate_alpha_opaque_triangle_precise(float2  v0_2, float2  v1_2, float2  v2_2, float2  hardness_5, float2  p_3)
{
    ...
    float2  _S1086 = p_3 - v0_2;
    float2  _S1087 = p_3 - v1_2;
    float2  _S1088 = p_3 - v2_2;
    float _S1089 = e0_5.x;
    float _S1090 = e1_5.y;
    float _S1091 = e0_5.y;
    float _S1092 = e1_5.x;
    float _S1093 = _S1089 * _S1090 - _S1091 * _S1092;
    float se_2 = float((F32_sign((_S1093))));
    float _S1094 = hardness_5.x;
    float _S1095 = 1.0f - clamp_0(hardness_5.y, 0.00499999988824129f, 0.99500000476837158f);
    float a_7 = 1.0f - (1.0f + float((F32_sign(((F32_max(((F32_max((se_2 * (_S1086.x * _S1091 - _S1086.y * _S1089)), (se_2 * (_S1087.x * _S1090 - _S1087.y * _S1092))))), (se_2 * (_S1088.x * e2_3.y - _S1088.y * e2_3.x)))))))) * (F32_min(((F32_min((length_0(_S1086 - e0_5 * make_float2 (clamp_0(dot_1(_S1086, e0_5) / dot_1(e0_5, e0_5), 0.0f, 1.0f)))), (length_0(_S1087 - e1_5 * make_float2 (clamp_0(dot_1(_S1087, e1_5) / dot_1(e1_5, e1_5), 0.0f, 1.0f))))))), (length_0(_S1088 - e2_3 * make_float2 (clamp_0(dot_1(_S1088, e2_3) / dot_1(e2_3, e2_3), 0.0f, 1.0f)))))) / ((F32_abs((_S1093))) / (length_0(e0_5) + length_0(e1_5) + length_0(e2_3)))) * (1.0f - (F32_exp2((-1.0f / _S1095))));
    float _S1096;
    if(a_7 <= 0.0f)
    {
        _S1096 = 0.0f;
    ...
    {
        _S1096 = (F32_min(((F32_pow((a_7), (_S1095)))), (0.99900001287460327f)));
    }
    return _S1094 * _S1096;
}

inline __device__ float s_primal_ctx_dot_1(float2  _S1097, float2  _S1098)
{
    return dot_1(_S1097, _S1098);
}

inline __device__ void s_bwd_prop_dot_1(DiffPair_vectorx3Cfloatx2C2x3E_0 * _S1099, DiffPair_vectorx3Cfloatx2C2x3E_0 * _S1100, float _S1101)
{
    _d_dot_1(_S1099, _S1100, _S1101);
    return;
}
...
inline __device__ void s_bwd_prop_evaluate_alpha_opaque_triangle_precise_0(DiffPair_vectorx3Cfloatx2C2x3E_0 * dpv0_1, DiffPair_vectorx3Cfloatx2C2x3E_0 * dpv1_1, DiffPair_vectorx3Cfloatx2C2x3E_0 * dpv2_1, DiffPair_vectorx3Cfloatx2C2x3E_0 * dphardness_1, float2  p_4, float _s_dOut_5)
{
    ...
    float2  _S1102 = p_4 - (*dpv0_1).primal_0;
    float _S1103 = s_primal_ctx_dot_1(_S1102, e0_6);
    float _S1104 = s_primal_ctx_dot_1(e0_6, e0_6);
    float _S1105 = _S1103 / _S1104;
    float _S1106 = _S1104 * _S1104;
    float _S1107 = s_primal_ctx_clamp_0(_S1105, 0.0f, 1.0f);
    float2  _S1108 = make_float2 (_S1107);
    float2  _S1109 = _S1102 - e0_6 * make_float2 (_S1107);
    float _S1110 = length_0(_S1109);
    float2  _S1111 = p_4 - (*dpv1_1).primal_0;
    float _S1112 = s_primal_ctx_dot_1(_S1111, e1_6);
    float _S1113 = s_primal_ctx_dot_1(e1_6, e1_6);
    float _S1114 = _S1112 / _S1113;
    float _S1115 = _S1113 * _S1113;
    float _S1116 = s_primal_ctx_clamp_0(_S1114, 0.0f, 1.0f);
    float2  _S1117 = make_float2 (_S1116);
    float2  _S1118 = _S1111 - e1_6 * make_float2 (_S1116);
    float _S1119 = length_0(_S1118);
    float2  _S1120 = p_4 - (*dpv2_1).primal_0;
    float _S1121 = s_primal_ctx_dot_1(_S1120, e2_4);
    float _S1122 = s_primal_ctx_dot_1(e2_4, e2_4);
    float _S1123 = _S1121 / _S1122;
    float _S1124 = _S1122 * _S1122;
    float _S1125 = s_primal_ctx_clamp_0(_S1123, 0.0f, 1.0f);
    float2  _S1126 = make_float2 (_S1125);
    float2  _S1127 = _S1120 - e2_4 * make_float2 (_S1125);
    float _S1128 = length_0(_S1127);
    float _S1129 = e0_6.x;
    float _S1130 = e1_6.y;
    float _S1131 = e0_6.y;
    float _S1132 = e1_6.x;
    float _S1133 = _S1129 * _S1130 - _S1131 * _S1132;
    float se_3 = float((F32_sign((_S1133))));
    float _S1134 = _S1102.x;
    float _S1135 = _S1102.y;
    float s0_0 = se_3 * (_S1134 * _S1131 - _S1135 * _S1129);
    float _S1136 = _S1111.x;
    float _S1137 = _S1111.y;
    float s1_0 = se_3 * (_S1136 * _S1130 - _S1137 * _S1132);
    float _S1138 = _S1120.x;
    float _S1139 = e2_4.y;
    float _S1140 = _S1120.y;
    float _S1141 = e2_4.x;
    float s2_0 = se_3 * (_S1138 * _S1139 - _S1140 * _S1141);
    float _S1142 = s_primal_ctx_max_0(s0_0, s1_0);
    float sv_0 = float((F32_sign((s_primal_ctx_max_0(_S1142, s2_0)))));
    float _S1143 = s_primal_ctx_min_0(_S1110, _S1119);
    float dv_0 = sv_0 * s_primal_ctx_min_0(_S1143, _S1128);
    float _S1144 = s_primal_ctx_abs_0(_S1133);
    float _S1145 = length_0(e0_6) + length_0(e1_6) + length_0(e2_4);
    float dmax_1 = _S1144 / _S1145;
    float _S1146 = _S1145 * _S1145;
    float _S1147 = (*dphardness_1).primal_0.x;
    float _S1148 = (*dphardness_1).primal_0.y;
    float _S1149 = dmax_1 * dmax_1;
    float _S1150 = 1.0f + dv_0 / dmax_1;
    float _S1151 = 1.0f - s_primal_ctx_clamp_0(_S1148, 0.00499999988824129f, 0.99500000476837158f);
    float _S1152 = -1.0f / _S1151;
    float _S1153 = _S1151 * _S1151;
    float _S1154 = 1.0f - s_primal_ctx_exp2_0(_S1152);
    float a_8 = 1.0f - _S1150 * _S1154;
    bool _S1155 = a_8 <= 0.0f;
    float _S1156;
    float _S1157;
    if(_S1155)
    {
    ...
    {
        float _S1158 = s_primal_ctx_pow_0(a_8, _S1151);
        _S1156 = s_primal_ctx_min_0(_S1158, 0.99900001287460327f);
        _S1157 = _S1158;
    }
    float _S1159 = _S1147 * _s_dOut_5;
    float _S1160 = _S1156 * _s_dOut_5;
    if(_S1155)
    {
        _S1156 = 0.0f;
        _S1157 = 0.0f;
    ...
    else
    {
        ...
        (&_S1161)->primal_0 = _S1157;
        (&_S1161)->differential_0 = 0.0f;
        DiffPair_float_0 _S1162;
        (&_S1162)->primal_0 = 0.99900001287460327f;
        (&_S1162)->differential_0 = 0.0f;
        s_bwd_prop_min_0(&_S1161, &_S1162, _S1159);
        DiffPair_float_0 _S1163;
        (&_S1163)->primal_0 = a_8;
        (&_S1163)->differential_0 = 0.0f;
        DiffPair_float_0 _S1164;
        (&_S1164)->primal_0 = _S1151;
        (&_S1164)->differential_0 = 0.0f;
        s_bwd_prop_pow_0(&_S1163, &_S1164, _S1161.differential_0);
        _S1156 = _S1163.differential_0;
        _S1157 = _S1164.differential_0;
    }
    float _S1165 = - _S1156;
    float _S1166 = _S1154 * _S1165;
    float _S1167 = - (_S1150 * _S1165);
    DiffPair_float_0 _S1168;
    (&_S1168)->primal_0 = _S1152;
    (&_S1168)->differential_0 = 0.0f;
    s_bwd_prop_exp2_0(&_S1168, _S1167);
    float _S1169 = - (-1.0f * - (_S1168.differential_0 / _S1153) + _S1157);
    float _S1170 = _S1166 / _S1149;
    float s_diff_dmax_T_1 = dv_0 * - _S1170;
    float s_diff_dv_T_0 = dmax_1 * _S1170;
    DiffPair_float_0 _S1171;
    (&_S1171)->primal_0 = _S1148;
    (&_S1171)->differential_0 = 0.0f;
    DiffPair_float_0 _S1172;
    (&_S1172)->primal_0 = 0.00499999988824129f;
    (&_S1172)->differential_0 = 0.0f;
    DiffPair_float_0 _S1173;
    (&_S1173)->primal_0 = 0.99500000476837158f;
    (&_S1173)->differential_0 = 0.0f;
    s_bwd_prop_clamp_0(&_S1171, &_S1172, &_S1173, _S1169);
    float _S1174 = s_diff_dmax_T_1 / _S1146;
    float _S1175 = _S1144 * - _S1174;
    float _S1176 = _S1145 * _S1174;
    float2  _S1177 = make_float2 (0.0f);
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1178;
    (&_S1178)->primal_0 = e2_4;
    (&_S1178)->differential_0 = _S1177;
    s_bwd_length_impl_0(&_S1178, _S1175);
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1179;
    (&_S1179)->primal_0 = e1_6;
    (&_S1179)->differential_0 = _S1177;
    s_bwd_length_impl_0(&_S1179, _S1175);
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1180;
    (&_S1180)->primal_0 = e0_6;
    (&_S1180)->differential_0 = _S1177;
    s_bwd_length_impl_0(&_S1180, _S1175);
    DiffPair_float_0 _S1181;
    (&_S1181)->primal_0 = _S1133;
    (&_S1181)->differential_0 = 0.0f;
    s_bwd_prop_abs_0(&_S1181, _S1176);
    float _S1182 = sv_0 * s_diff_dv_T_0;
    DiffPair_float_0 _S1183;
    (&_S1183)->primal_0 = _S1143;
    (&_S1183)->differential_0 = 0.0f;
    DiffPair_float_0 _S1184;
    (&_S1184)->primal_0 = _S1128;
    (&_S1184)->differential_0 = 0.0f;
    s_bwd_prop_min_0(&_S1183, &_S1184, _S1182);
    DiffPair_float_0 _S1185;
    (&_S1185)->primal_0 = _S1110;
    (&_S1185)->differential_0 = 0.0f;
    DiffPair_float_0 _S1186;
    (&_S1186)->primal_0 = _S1119;
    (&_S1186)->differential_0 = 0.0f;
    s_bwd_prop_min_0(&_S1185, &_S1186, _S1183.differential_0);
    DiffPair_float_0 _S1187;
    (&_S1187)->primal_0 = _S1142;
    (&_S1187)->differential_0 = 0.0f;
    DiffPair_float_0 _S1188;
    (&_S1188)->primal_0 = s2_0;
    (&_S1188)->differential_0 = 0.0f;
    s_bwd_prop_max_0(&_S1187, &_S1188, 0.0f);
    DiffPair_float_0 _S1189;
    (&_S1189)->primal_0 = s0_0;
    (&_S1189)->differential_0 = 0.0f;
    DiffPair_float_0 _S1190;
    (&_S1190)->primal_0 = s1_0;
    (&_S1190)->differential_0 = 0.0f;
    s_bwd_prop_max_0(&_S1189, &_S1190, _S1187.differential_0);
    float _S1191 = se_3 * _S1188.differential_0;
    float _S1192 = - _S1191;
    float _S1193 = _S1140 * _S1192;
    float _S1194 = _S1141 * _S1192;
    float _S1195 = _S1138 * _S1191;
    float _S1196 = _S1139 * _S1191;
    float _S1197 = se_3 * _S1190.differential_0;
    float _S1198 = - _S1197;
    float _S1199 = _S1132 * _S1198;
    float _S1200 = _S1130 * _S1197;
    float _S1201 = se_3 * _S1189.differential_0;
    float _S1202 = - _S1201;
    float _S1203 = _S1129 * _S1202;
    float _S1204 = _S1131 * _S1201;
    float _S1205 = - _S1181.differential_0;
    float _S1206 = _S1137 * _S1198 + _S1131 * _S1205;
    float _S1207 = _S1134 * _S1201 + _S1132 * _S1205;
    float _S1208 = _S1136 * _S1197 + _S1129 * _S1181.differential_0;
    float _S1209 = _S1135 * _S1202 + _S1130 * _S1181.differential_0;
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1210;
    (&_S1210)->primal_0 = _S1127;
    (&_S1210)->differential_0 = _S1177;
    s_bwd_length_impl_0(&_S1210, _S1184.differential_0);
    float2  _S1211 = - _S1210.differential_0;
    float2  _S1212 = e2_4 * _S1211;
    float2  _S1213 = _S1126 * _S1211;
    float _S1214 = _S1212.x + _S1212.y;
    DiffPair_float_0 _S1215;
    (&_S1215)->primal_0 = _S1123;
    (&_S1215)->differential_0 = 0.0f;
    DiffPair_float_0 _S1216;
    (&_S1216)->primal_0 = 0.0f;
    (&_S1216)->differential_0 = 0.0f;
    DiffPair_float_0 _S1217;
    (&_S1217)->primal_0 = 1.0f;
    (&_S1217)->differential_0 = 0.0f;
    s_bwd_prop_clamp_0(&_S1215, &_S1216, &_S1217, _S1214);
    float _S1218 = _S1215.differential_0 / _S1124;
    float _S1219 = _S1121 * - _S1218;
    float _S1220 = _S1122 * _S1218;
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1221;
    (&_S1221)->primal_0 = e2_4;
    (&_S1221)->differential_0 = _S1177;
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1222;
    (&_S1222)->primal_0 = e2_4;
    (&_S1222)->differential_0 = _S1177;
    s_bwd_prop_dot_1(&_S1221, &_S1222, _S1219);
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1223;
    (&_S1223)->primal_0 = _S1120;
    (&_S1223)->differential_0 = _S1177;
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1224;
    (&_S1224)->primal_0 = e2_4;
    (&_S1224)->differential_0 = _S1177;
    s_bwd_prop_dot_1(&_S1223, &_S1224, _S1220);
    float2  _S1225 = - (_S1210.differential_0 + _S1223.differential_0 + make_float2 (_S1196, _S1194));
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1226;
    (&_S1226)->primal_0 = _S1118;
    (&_S1226)->differential_0 = _S1177;
    s_bwd_length_impl_0(&_S1226, _S1186.differential_0);
    float2  _S1227 = - _S1226.differential_0;
    float2  _S1228 = e1_6 * _S1227;
    float2  _S1229 = _S1117 * _S1227;
    float _S1230 = _S1228.x + _S1228.y;
    DiffPair_float_0 _S1231;
    (&_S1231)->primal_0 = _S1114;
    (&_S1231)->differential_0 = 0.0f;
    DiffPair_float_0 _S1232;
    (&_S1232)->primal_0 = 0.0f;
    (&_S1232)->differential_0 = 0.0f;
    DiffPair_float_0 _S1233;
    (&_S1233)->primal_0 = 1.0f;
    (&_S1233)->differential_0 = 0.0f;
    s_bwd_prop_clamp_0(&_S1231, &_S1232, &_S1233, _S1230);
    float _S1234 = _S1231.differential_0 / _S1115;
    float _S1235 = _S1112 * - _S1234;
    float _S1236 = _S1113 * _S1234;
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1237;
    (&_S1237)->primal_0 = e1_6;
    (&_S1237)->differential_0 = _S1177;
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1238;
    (&_S1238)->primal_0 = e1_6;
    (&_S1238)->differential_0 = _S1177;
    s_bwd_prop_dot_1(&_S1237, &_S1238, _S1235);
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1239;
    (&_S1239)->primal_0 = _S1111;
    (&_S1239)->differential_0 = _S1177;
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1240;
    (&_S1240)->primal_0 = e1_6;
    (&_S1240)->differential_0 = _S1177;
    s_bwd_prop_dot_1(&_S1239, &_S1240, _S1236);
    float2  _S1241 = - (_S1226.differential_0 + _S1239.differential_0 + make_float2 (_S1200, _S1199));
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1242;
    (&_S1242)->primal_0 = _S1109;
    (&_S1242)->differential_0 = _S1177;
    s_bwd_length_impl_0(&_S1242, _S1185.differential_0);
    float2  _S1243 = - _S1242.differential_0;
    float2  _S1244 = e0_6 * _S1243;
    float2  _S1245 = _S1108 * _S1243;
    float _S1246 = _S1244.x + _S1244.y;
    DiffPair_float_0 _S1247;
    (&_S1247)->primal_0 = _S1105;
    (&_S1247)->differential_0 = 0.0f;
    DiffPair_float_0 _S1248;
    (&_S1248)->primal_0 = 0.0f;
    (&_S1248)->differential_0 = 0.0f;
    DiffPair_float_0 _S1249;
    (&_S1249)->primal_0 = 1.0f;
    (&_S1249)->differential_0 = 0.0f;
    s_bwd_prop_clamp_0(&_S1247, &_S1248, &_S1249, _S1246);
    float _S1250 = _S1247.differential_0 / _S1106;
    float _S1251 = _S1103 * - _S1250;
    float _S1252 = _S1104 * _S1250;
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1253;
    (&_S1253)->primal_0 = e0_6;
    (&_S1253)->differential_0 = _S1177;
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1254;
    (&_S1254)->primal_0 = e0_6;
    (&_S1254)->differential_0 = _S1177;
    s_bwd_prop_dot_1(&_S1253, &_S1254, _S1251);
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1255;
    (&_S1255)->primal_0 = _S1102;
    (&_S1255)->differential_0 = _S1177;
    DiffPair_vectorx3Cfloatx2C2x3E_0 _S1256;
    (&_S1256)->primal_0 = e0_6;
    (&_S1256)->differential_0 = _S1177;
    s_bwd_prop_dot_1(&_S1255, &_S1256, _S1252);
    float2  _S1257 = - (_S1242.differential_0 + _S1255.differential_0 + make_float2 (_S1204, _S1203));
    float2  _S1258 = _S1178.differential_0 + _S1213 + _S1222.differential_0 + _S1221.differential_0 + _S1224.differential_0 + make_float2 (_S1193, _S1195);
    float2  _S1259 = - _S1258;
    float2  _S1260 = _S1179.differential_0 + _S1229 + _S1238.differential_0 + _S1237.differential_0 + _S1240.differential_0 + make_float2 (_S1206, _S1208);
    float2  _S1261 = - _S1260;
    float2  _S1262 = _S1180.differential_0 + _S1245 + _S1254.differential_0 + _S1253.differential_0 + _S1256.differential_0 + make_float2 (_S1209, _S1207);
    float2  _S1263 = - _S1262;
    float2  _S1264 = make_float2 (_S1160, _S1171.differential_0);
    dphardness_1->primal_0 = (*dphardness_1).primal_0;
    dphardness_1->differential_0 = _S1264;
    float2  _S1265 = _S1225 + _S1259 + _S1260;
    dpv2_1->primal_0 = (*dpv2_1).primal_0;
    dpv2_1->differential_0 = _S1265;
    float2  _S1266 = _S1241 + _S1261 + _S1262;
    dpv1_1->primal_0 = (*dpv1_1).primal_0;
    dpv1_1->differential_0 = _S1266;
    float2  _S1267 = _S1257 + _S1258 + _S1263;
    dpv0_1->primal_0 = (*dpv0_1).primal_0;
    dpv0_1->differential_0 = _S1267;
    return;
}

inline __device__ void s_bwd_evaluate_alpha_opaque_triangle_precise_0(DiffPair_vectorx3Cfloatx2C2x3E_0 * _S1268, DiffPair_vectorx3Cfloatx2C2x3E_0 * _S1269, DiffPair_vectorx3Cfloatx2C2x3E_0 * _S1270, DiffPair_vectorx3Cfloatx2C2x3E_0 * _S1271, float2  _S1272, float _S1273)
{
    s_bwd_prop_evaluate_alpha_opaque_triangle_precise_0(_S1268, _S1269, _S1270, _S1271, _S1272, _S1273);
    return;
}
