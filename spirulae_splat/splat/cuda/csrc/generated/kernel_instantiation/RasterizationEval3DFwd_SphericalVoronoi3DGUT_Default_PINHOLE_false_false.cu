...
>(
    ...
    const bool packed,
    const SphericalVoronoi3DGUT_Default::Screen::Buffer splat_buffer,
    ...
    SphericalVoronoi3DGUT_Default::RenderOutput::Buffer render_colors, // [I, image_height, image_width, ...]
    float *__restrict__ render_Ts, // [I, image_height, image_width, 1]
    int32_t *__restrict__ last_ids, // [I, image_height, image_width]
    SphericalVoronoi3DGUT_Default::RenderOutput::Buffer render_colors2, // [I, image_height, image_width, ...]
    SphericalVoronoi3DGUT_Default::RenderOutput::Buffer render_distortions, // [I, image_height, image_width, ...]
