...
"""Self-contained LPIPS based on torchmetrics, removed unnecessary copy/synchronization"""
...
class LearnedPerceptualImagePatchSimilarity(torch.nn.Module):
    ...
    def _forward_reduce_state_update(self, img1: Tensor, img2: Tensor) -> Any:
        ...
        return _lpips_compute(loss, reduction=self.reduction)
